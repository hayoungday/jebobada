...
const EvidenceEdit = (props) => {
    ...
    const [mainevdi, setMainEvdi] = useState(props.location.state.ismain);


    const [checkedItems, setCheckedItems] = useState(props.location.state.bullying)
    ...
    const addEvidence = () => {
        try {
            ...
            formData.append('type',checkedItems)
