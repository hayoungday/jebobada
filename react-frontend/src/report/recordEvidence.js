        ...
        <div className="yoon_overview-container">
          <Stack direction="row" alignItems="center" spacing={12}>
            ...
            <span className="yoon_overview-tilte-desc">
              녹음 증거 자료 목록입니다.<p/>
              해시값 비교와 편집(위변조)여부 분석을 통해 증거 자료의 악의적 편집 여부를 알 수 있습니다.
            </span>
          </Stack>
          <br/>

          
          <sapn className="yoon_overview-subtitle">편집 및 조작 여부 분석 결과</sapn>
          <br/><br/>
            ...
            *조작 : 음성 파일에 편집된 흔적이 있는지에 대한 정보입니다.
            ...
            <span className="reason_contents_desc">
              ...
              (3) 인공지능을 사용해 음성 파일이 짜깁기 되었는지 판단합니다.<br/>
                  - 짜깁기 된 음성 파일과 정상 음성 파일을 사용해 CNN(STFT)라는 인공지능(머신러닝) 모델을 훈련시켜 사용합니다. (정확도 : 90 %)<br/>
            </span>
            <br/><br/><br/>
            <sapn className="yoon_overview-subtitle">편집 및 조작 여부 판단 결과</sapn>
